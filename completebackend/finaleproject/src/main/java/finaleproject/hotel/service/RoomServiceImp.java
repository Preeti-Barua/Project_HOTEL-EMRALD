...
public class RoomServiceImp implements RoomserviceIntf {
	...
	@Override
	public Outputc bookroom(int roomno) {
		Outputc o= new Outputc(0,"fault occured",null);
		Optional<Rooms> u=d.findById(roomno);
		if(u.isPresent())
		{
			Rooms u1=u.get();
			try {
				u1.setBooking_status("Booked");
				d.save(u1);
				o.setReason("Booked successfully");
				o.setStatus(1);
			} catch (Exception e) {
//				 TODO Auto-generated catch block
				e.printStackTrace();
	...
	@Override
	public Outputc unBookRoom(int roomno) {
		Outputc o= new Outputc(0,"fault occured",null);
		Optional<Rooms> u=d.findById(roomno);
		if(u.isPresent())
		{
			Rooms u1=u.get();
			try {
				u1.setBooking_status("UnBooked");
				d.save(u1);
				o.setReason("UnBooked successfully");
				o.setStatus(1);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();

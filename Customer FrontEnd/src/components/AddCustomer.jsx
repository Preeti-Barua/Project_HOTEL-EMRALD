...
export default class AddCustomer extends Component {
    ...
    saveCustomer= (e) =>{
        ...
        let Customer= {
            ...
            Service.createCustomer(Customer).then(res =>{
                let c=res.data;
                console.log(c);
    ...
    getTitle()
    {
        ...
        {
            return <div className="text-center">Customer could not be added</div>
        }
    }
                    ...
                    <div className="row">
                        ...
                        <div className="card-body">
                            <form>
                                            ...
                                            <div className="form-group">
                                                <label>Phone</label>
                                                <input placeholder="Contact Number" name="phoneno" size="5" className="form-control"
                                                value={this.state.Phno} onChange={this.changephonenoHandler}/>
                                            </div>
                                            <div className="form-group">
                                                <label>Permanent Address</label>
                                                <input placeholder="P Address" name="permanentaddress" required className="form-control"
                                            ...
                                            <div className="form-group">
                                                ...
                                                value={this.state.Roomno} onChange={this.changeroomnoHandler} disabled = "disabled"/>
                                            </div>
